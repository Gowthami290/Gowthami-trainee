...
&nbsp;&nbsp;&nbsp;&nbsp;
<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextPhoneNumber" ErrorMessage="Phone Number should be in the format XX-XXXXXXX or XXX-XXXXXXX" ForeColor="Red" ValidationExpression="^(\d{2}-\d{8}|\d{3}-\d{7})$"></asp:RegularExpressionValidator>
<br />
<br />
            Email :
